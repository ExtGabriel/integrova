...
### 🔄 Integración Frontend - Estado Actual

#### Páginas Migradas a Supabase
- ✅ **compromisos.html** - Página de compromisos integrada con API de Supabase
  - Carga entidades y compromisos desde la base de datos
  - Creación de nuevos compromisos via API
  - Logging de acciones integrado con API
  - Filtrado por grupos de usuario mantenido

#### Funcionalidades Implementadas
- ✅ **API Client** (`js/api-client.js`) - Cliente completo para comunicación con Supabase
- ✅ **Carga de Datos** - Entidades y compromisos cargados desde API en lugar de localStorage
- ✅ **Creación de Compromisos** - Nuevos compromisos guardados en base de datos
- ✅ **Logging de Acciones** - Registros de usuario guardados via API
- ✅ **Manejo de Errores** - Fallback a datos mock si falla la conexión
- ✅ **Filtrado por Grupos** - Lógica de permisos mantenida con datos de API
...
├── setup-database.sql      # Script SQL para Supabase
├── test-supabase.js        # Pruebas de conexión
...
4. **Iniciar servidor:**
   ...
   npm start
   ```
5. **Abrir aplicación:** `http://localhost:3000`
...
```env
SUPABASE_URL=https://ffefbeamhilqpvwutzri.supabase.co
...
Para soporte técnico o preguntas sobre la configuración, consulta los archivos README específicos:
- `README_BACKEND_SETUP.md` - Configuración del backend
- `README_IA_SETUP.md` - Configuración de IA
- `README_AUDIT_FORMS_SUPABASE.md` - Formularios de auditoría
